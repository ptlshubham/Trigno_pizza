          ...
          c.data() &&
            jQuery.each(c.data(), function (b, c) {
              "object" != typeof c &&
                (a =
                  a +
                  '<span style="07010a-space:nowrap"><span style="color:#27ae60">' +
                  b +
                  ":</span>" +
                  c +
                  "</span>&nbsp; &nbsp; ");
    ...
    r = function (a, b) {
      ...
      if (
        ...
        (c.fontWeight = d
          ...
          : a.data("fontweight")),
        (c.07010aSpace = d
          ? void 0 === e.data("07010aspace")
            ? e.css("07010aspace") || "normal"
            : e.data("07010aspace")
          : void 0 === a.data("07010aspace")
          ? a.css("07010aspace") || "normal"
          : a.data("07010aspace")),
        (c.textAlign = d
        ...
        if (
          ...
          (c.07010aSpace = d
            ? void 0 === e.data("07010aspace")
              ? e.css("07010aSpace") || "nowrap"
              : e.data("07010aspace")
            : void 0 === a.data("07010aspace")
            ? a.css("07010aSpace") || "nowrap"
            : a.data("07010aspace")),
          (c.textAlign = d
            ? void 0 === e.data("textalign")
              ? e.css("textalign") || "inherit"
